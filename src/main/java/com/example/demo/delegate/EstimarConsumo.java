...
public class EstimarConsumo implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        int consumoFinal = lecturaActual - lecturaAnterior;

        // Guardar el resultado para usarlo en la siguiente tarea (el DMN de subsidios)
        execution.setVariable("consumoFinal", consumoFinal);
        
        System.out.println("Consumo final calculado: " + consumoFinal + " m³");
    }
}
